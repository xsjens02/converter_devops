...
export default () => {
    ...
    let responses = http.batch([
        ['GET', `${baseUrl}/volumes/convert/value=10&from=2&to=3`],
        ['GET', `${baseUrl}/volumes/add/a=10&aUnit=2&b=500&bUnit=0&resultUnit=3`],
        ['GET', `${baseUrl}/volumes/subtract/a=8&aUnit=2&b=500&bUnit=0&resultUnit=3`],
        ['GET', `${baseUrl}/volumes/difference/a=5&aUnit=2&b=3&bUnit=3&resultUnit=3`],
        ['GET', `${baseUrl}/volumes/scale/value=2&valueUnit=2&factor=5&resultUnit=3`],
        ['GET', `${baseUrl}/volumes/percentage/a=1&part=2&b=1&whole=3`],
        ['GET', `${baseUrl}/weights/convert/value=10&from=2&to=3`],
        ['GET', `${baseUrl}/weights/add/a=10&aUnit=2&b=500&bUnit=0&resultUnit=3`],
        ['GET', `${baseUrl}/weights/subtract/a=8&aUnit=2&b=500&bUnit=0&resultUnit=3`],
        ['GET', `${baseUrl}/weights/difference/a=5&aUnit=2&b=3&bUnit=3&resultUnit=3`],
        ['GET', `${baseUrl}/weights/scale/value=2&valueUnit=2&factor=5&resultUnit=3`],
        ['GET', `${baseUrl}/weights/percentage/a=1&part=2&b=1&whole=3`]
    ]);
